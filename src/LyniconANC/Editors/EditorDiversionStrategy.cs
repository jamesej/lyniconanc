...
{
    public class EditorDiversionStrategy : DiversionStrategy
    {
        readonly string editorController;
        readonly string editorArea;
        readonly ContentPermission writePermission;

        public EditorDiversionStrategy(string editorArea, string editorController, ContentPermission writePermission = null)
        {
