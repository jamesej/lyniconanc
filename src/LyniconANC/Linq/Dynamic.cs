...
using static Lynicon.Utility.ReflectionX;
        ...
        public Type GetDynamicClass(IEnumerable<DynamicProperty> properties, IEnumerable<Type> interfaces) {
            ...
            try {
                ...
                if (!classes.TryGetValue(signature, out type)) {
                    type = CreateDynamicClass(signature.properties, interfaces);
        ...
        MemberInfo FindPropertyOrField(Type type, string memberName, bool staticAccess)
        {
            ...
            foreach (Type t in SelfAndBaseTypes(type))
            {
                MemberInfo[] members = t.FindMembers(MemberTypes.Property | MemberTypes.Field,
                    flags, ReflectionX.FilterNameIgnoreCase, memberName);
        ...
        int FindMethod(Type type, string methodName, bool staticAccess, Expression[] args, out MethodBase method) {
            ...
            foreach (Type t in SelfAndBaseTypes(type)) {
                MemberInfo[] members = t.FindMembers(MemberTypes.Method,
                    flags, ReflectionX.FilterNameIgnoreCase, methodName);
        ...
        static object ParseEnum(string name, Type type) {
            if (type.IsEnum()) {
                MemberInfo[] memberInfos = type.FindMembers(MemberTypes.Field,
                    ...
                    ReflectionX.FilterNameIgnoreCase, name);
